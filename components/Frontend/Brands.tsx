...
const Brands = () => {
  return (
    <>
      ...
      <section className="bg-slate-50 py-20 dark:bg-dark lg:py-[60px]">
        <h2 className="text-center pb-6">Trused By</h2>
...
const SingleImage = ({ href, imgSrc, Alt }: SingleImagePrors) => {
  return (
    <>
      <a
        href={href}
